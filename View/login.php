...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../Public/Css/LoginSignUp/demo.css" />
        <link rel="stylesheet" type="text/css" href="../Public/Css/LoginSignUp/style.css" />
        <link rel="stylesheet" type="text/css" href="../Public/Css/LoginSignUp/animate-custom.css" />
    </head>
    <body>
        <div class="container">
                    ...
                    <div id="wrapper">
                        ...
                        <div id="register" class="animate form">
                            <form  action="" autocomplete="on"> 
                                ...
                                <p> 
                                    <label for="address" data-icon="">Address</label>
                                    <input id="addresssignup" name="addresssignup" required="required" type="text" placeholder="144 Xuan Thuy, Cau Giay, Ha Noi" />
                                </p>

                                <p> 
                                    <label for="phone" data-icon="">Your phone</label>
                                    <input id="phonesignup" name="phonesignup" required="required" type="text" placeholder="0963215435" />
                                </p>
